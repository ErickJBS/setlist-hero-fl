...
class _EventPageMonthState extends State<EventPageMonth> {
  ...
  _EventPageMonthState(){
    events.add(new Events(bandName: 'Twenty One Pilots', date: 'May 28th', tourName: 'Bandito Tour'));
    events.add(new Events(bandName: 'Dua Lipa', date: 'May 29th', tourName: 'Nostalgia Tour'));
    events.add(new Events(bandName: 'Paramore', date: 'May 30th', tourName: 'Laughter Tour'));
  }
